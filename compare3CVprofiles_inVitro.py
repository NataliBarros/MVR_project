...
# Good
# TAU_MEM_EACH = {'c1':19.1, 'c2':30.4, 'c4':32.9, 'c12':35.5, 'c31':31.7, 'c59':28.6, 'c60':46.9, 'c61':31.6, 'c62':23.0, 'c64':34.1, 'c65':18.4, 'c69':53.9, 'c70':18.7, 'c71':37.5, 'c73':36.7, 'c74':25.0, 'c75':39.0, 'c77':48.0, 'c78':43.8, 'c79':17.1, 'c81':25.6, 'c83':46.7}
# One
...
for i in range(len(list_key)):
    ...
    for sc1 in sample_connection:
        ...
        amps1.append(amplitudes1)

        #print 'amps1', amplitudes1
        ...
        # filt sc
        fsc1 = at.butter_lowpass_filter(sc1 - sc1[0], 50, fs, order=5)

        max2, min2, amplitudes2 = at.compute_amplitude2(fsc1, STIM_TIMES, t_wind_aft)
        amps2.append(amplitudes2)
    ...
    amps_MEAN1 = np.mean(amps1, axis = 0)
    amps_MEAN2 = np.mean(amps2, axis = 0)
    print 'amp1', amps_MEAN1
    print 'amp2', amps_MEAN2
...
#
#     # sample_connection_filt = []
#     # for sc2 in sample_connection:
#     #     # filt sc
#     #     fsc2 = at.butter_lowpass_filter(sc2 - sc2[0], 50, fs, order=5)
#     #     sample_connection_filt.append(fsc2)
#
#     amp_means = []
...
#     amp_std2 = (len(sample_connection)-1)*np.sqrt(np.sum(DIF2, axis = 0)/N2)
#     #print 'std2', amp_std2
#
